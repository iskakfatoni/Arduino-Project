...
void setup() {
  ...
  esp.wifiConnect("RUANG_TU","smkpgrimr");
...
loop_start:  
  ...
  if(wifiConnected) {   
    ...
    char str_field1[6] , str_field2[6] , str_field3[6] , str_field4[6];
      ...
      sprintf(buff, "/channels/274989/fields/1/last");
      Serial.println(buff);
      ...
      delay(10000);  
      sprintf(buff, "/channels/274989/fields/2/last");
      Serial.println(buff);
      ...
      delay(10000);  
      sprintf(buff, "/channels/274989/fields/3/last");
      Serial.println(buff);
     ...
     delay(10000);  
      sprintf(buff, "/channels/274989/fields/4/last");              // field x last Data
      Serial.println(buff);
      ...
      if(data4) {
         ...
         dtostrf(0.1, 2, 1, str_field4);   
          ...
          sprintf(buff, "//update?key= ZU1TQQTWGAJZEU91&field1=%s&field2=%s&field3=%s&field4=%s",str_field1,str_field2,str_field3,str_field4);
          Serial.println(buff);
